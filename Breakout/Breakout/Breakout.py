...
class Game:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("pyBreakout | Cheick Berthe")
    ...
    def start(self):
        while 1:            
            ...
            # Draw ball
            pygame.draw.circle(self.screen, BLUE, (self.ball.left + BALL_RADIUS, self.ball.top + BALL_RADIUS), BALL_RADIUS)
